...
{		
    ...
    wp_enqueue_script( 'echarts', "https://cdnjs.cloudflare.com/ajax/libs/echarts/4.0.4/echarts.min.js", array('jquery'), "4.0.4", true);
    wp_enqueue_script( 'WP-GPX-Maps', plugins_url('/WP-GPX-Maps.js', __FILE__), array('jquery','googlemaps','echarts'), "1.3.00a40");
}
...
// Folgende Zeilen hinzugefügt
	...
	$output = '
		<div id="wpgpxmaps_'.$r.'" class="wpgpxmaps">
			...
			<div id="echart_'.$r.'" class="plot" style="width:'.$w.'; height:'.$gh.'"></div>
