...
{		
	...
	wp_enqueue_script( 'googlecharts', '//www.gstatic.com/charts/loader.js', array(), null ); 
    //wp_enqueue_script( 'highcharts', "//code.highcharts.com/3.0.10/highcharts.js", array('jquery'), "3.0.10", true);
    wp_enqueue_script( 'WP-GPX-Maps', plugins_url('/WP-GPX-Maps.js', __FILE__), array('jquery','googlemaps','googlecharts'), "1.3.00a27");
}
...
// Folgende Zeilen hinzugefügt
	...
	$output = '
		<div id="wpgpxmaps_'.$r.'" class="wpgpxmaps">
			...
			<div id="gchart_'.$r.'" class="plot" style="width:'.$w.'; height:'.$gh.'"></div>
