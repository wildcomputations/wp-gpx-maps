...
(function($) {
    ...
    $.fn.wpgpxmaps = function(params) {
		...
		var yAxisLabelFormatter  = function (value, index)
		{
        ...
        */
                ...
                google.maps.event.addListener(polylinenes[i], 'mouseover', function(event) {
                    if (marker) {
                        ...
                        if (echart) {
							...
							echart.setSelection([{row:ci,column:null}]);
							...
							//google.visualization.events.trigger(echart, 'onmousemove', {x : myx, y : myy});
        ...
        var graphh = jQuery('#echart_' + params.targetId).css("height");
		var chartOptions;
		var echart;
        ...
        if (graphDist != '' && (graphEle != '' || graphSpeed != '' || graphHr != '' || graphAtemp != '' || graphCad != '') && graphh != "0px") {
			...
			var xAxisOffset = 0;
			var increaseAxisOffset = function(currentOffset, decimals, suffix, maxValue)
			{
				return currentOffset + (10 * (3 + decimals + suffix.lenght + (maxValue+"").lenght) );
			}
				...
				xAxis: [{
					...
					axisLabel : {
						formatter: function (value, index) {					
							return Number(value).toFixed(l_x.dec) + l_x.suf;
						}												
					},
				}],
				yAxis: [],
			...
			formatterSettings.push([l_x.dec, l_x.suf ]);
			...
			*/
            ...
            if (graphEle != '') {
				...
				var yaxe = { 
					...
					axisLabel : {
						formatter: function (value, index) {					
							return Number(value).toFixed(l_y.dec) + l_y.suf;
						}		
					},
				};
                ...
                chartOptions.series.push({ 
					...
					data : eleData,
					color: color2,
					yAxis: chartOptions.series.length
                });
            ...
            if (graphSpeed != '') {
                ...
                for (i = 0; i < valLen; i++) {									
                    if (graphDist[i] != null)
						speedData.push(graphSpeed[i]);
                }

				formatterSettings.push([l_s.dec, l_s.suf ]);
                ...
                var yaxe = { 
					...
					axisLabel : {
						formatter: function (value, index) {	
							return Number(value).toFixed(l_s.dec) + l_s.suf;
						}
					},
				};
				xAxisOffset = increaseAxisOffset(xAxisOffset,l_s.dec, l_s.suf, "" );
                ...
                chartOptions.series.push({
                    ...
                    data: speedData,
                    color: color3,
                    yAxisIndex: chartOptions.yAxis.length - 1
                });
            ...
            if (graphHr != '') {
				...
				formatterSettings.push([l_hr.dec, l_hr.suf ]);
				...
				chartOptions.yAxis.push({ 
					...
					axisLabel : {
						formatter: function (value, index) {	
							return Number(value).toFixed(l_hr.dec) + l_hr.suf;
						}
					},
				});
				xAxisOffset = increaseAxisOffset(xAxisOffset,l_s.dec, l_s.suf, "" );
            ...
            if (graphCad != '') {
				...
				formatterSettings.push([l_cad.dec, l_cad.suf ]);
				...
				chartOptions.yAxis.push({ 
					...
					axisLabel : {
						formatter: function (value, index) {	
							return Number(value).toFixed(l_cad.dec) + l_cad.suf;
						}
					},
				});
				xAxisOffset = increaseAxisOffset(xAxisOffset,l_s.dec, l_s.suf, "" );
            ...
            if (graphGrade != '') {
				...
				formatterSettings.push([l_grade.dec, l_grade.suf ]);
				...
				chartOptions.yAxis.push({ 
					...
					axisLabel : {
						formatter: function (value, index) {	
							return Number(value).toFixed(l_grade.dec) + l_grade.suf;
						}
					},
				});
				xAxisOffset = increaseAxisOffset(xAxisOffset,l_s.dec, l_s.suf, "" );
            ...
            var echart = echarts.init(document.getElementById('echart_' + params.targetId));

			/*
			
			google.visualization.events.addListener(echart, 'ready', function(s){
				
				var container = document.getElementById('echart_' + params.targetId);
				
				cli = echart.getChartLayoutInterface();
			...
			google.visualization.events.addListener(echart, 'onmousemove', function(s){ 
			...
			*/
            ...
            jQuery("#echart_" + params.targetId).css("display", "none");
        }
